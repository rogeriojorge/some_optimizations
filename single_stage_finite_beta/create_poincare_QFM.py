...
import logging
logging.basicConfig()
logger = logging.getLogger('single_stageqs')
logger.setLevel(1)
...
for main_directory in [
                       'optimization_QH_len3.0',
                    #    'optimization_QH_len3.0_stage1',
                       'optimization_QH_len3.0_finitebeta_stage1',
                       'optimization_QH_len3.0_finitebeta',
                       'optimization_QA_len5.0',
                       'optimization_QA_len5.0_stage1',
                       'optimization_QA_len5.0_finitebeta_stage1',
                    #    'optimization_QA_len5.0_finitebeta'
                       ]:
    pprint(f'Now doing {main_directory}')
    volume_scale = 1.0
    nfieldlines = 8
    delta_R = 0.028
    tmax_fl = 6500
    ...
    vmec = Vmec(os.path.join(this_path,f'wout_final.nc')).wout.nfp
