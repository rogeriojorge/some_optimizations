...
# vmec_file = os.path.join(this_path,'wout_nfp2_QA.nc')
# output_dir = 'out_map_nfp2_QA_initial'
# vmec_file = os.path.join(this_path,'wout_nfp4_QH.nc')
...
# vmec_file = os.path.join(this_path,'output_MAXITER350_least_squares_nfp2_QA_QA_old/wout_final.nc')
# output_dir = 'out_map_nfp2_QA_QA_least_squares_old'
# vmec_file = os.path.join(this_path,'output_MAXITER350_least_squares_nfp4_QH_QH_old/see_min/wout_nfp4_QH_000_000000.nc')
# output_dir = 'out_map_nfp4_QH_QH_least_squares_old'
s_radius = 0.25
alpha_fieldline = 0
nphi= 131
nlambda = 33
