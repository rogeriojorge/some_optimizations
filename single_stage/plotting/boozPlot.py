...
def main(file,qvfilename):
	...
	# plt.savefig("BoozxformPlot1"+qvfilename+'.pdf', bbox_inches = 'tight', pad_inches = 0)
	...
	# plt.savefig("BoozxformPlot2"+qvfilename+'.pdf', bbox_inches = 'tight', pad_inches = 0)
	...
	b1 = Booz_xform()
	b1.read_boozmn(filename)
	print("Plot BOOZ_XFORM")
	fig = plt.figure(); bx.surfplot(b1, js=1,  fill=False, ncontours=35)
	plt.savefig("Boozxform_surfplot_1_stage1.pdf", bbox_inches = 'tight', pad_inches = 0); plt.close()
	fig = plt.figure(); bx.surfplot(b1, js=int(boozxform_nsurfaces/2), fill=False, ncontours=35)
	plt.savefig("Boozxform_surfplot_2_stage1.pdf", bbox_inches = 'tight', pad_inches = 0); plt.close()
	fig = plt.figure(); bx.surfplot(b1, js=boozxform_nsurfaces-1, fill=False, ncontours=35)
	plt.savefig("Boozxform_surfplot_3_stage1.pdf", bbox_inches = 'tight', pad_inches = 0); plt.close()
	fig = plt.figure(); bx.symplot(b1, helical_detail = True, sqrts=True)
	plt.savefig("Boozxform_symplot_stage1.pdf", bbox_inches = 'tight', pad_inches = 0); plt.close()
	fig = plt.figure(); bx.modeplot(b1, sqrts=True); plt.xlabel(r'$s=\psi/\psi_b$')
	plt.savefig("Boozxform_modeplot_stage1.pdf", bbox_inches = 'tight', pad_inches = 0); plt.close()
